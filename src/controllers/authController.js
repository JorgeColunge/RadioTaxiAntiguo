...
exports.login = async (req, res) => {
  ...
  console.log(`Datos recibidos para inicio de sesión: usuario ${id_usuario}, contraseña ${password}`);
  ...
  try {
    ...
    if (user.rows.length > 0) {
      console.log('Usuario encontrado en la base de datos:', user.rows[0]);
